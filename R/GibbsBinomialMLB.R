...
#' @param data An n dimensional vector consisting of binomial count-valued observations.
#' @param nn An n dimensional vector consisting of totals associated with binomial count-valued observations.
