...
#' @param ini Initial estimate of the proportions to aid in selecting hyperparameters. Default is the sample proportion.
...
#' @export
GibbsBernoulliMLB<-function(B,data,X,G,ini=NA,report=100,itmax=20,nslice=2){
  n = length(data)
  p = dim(X)[2]
  r = dim(G)[2]
  nn=matrix(1,n,1)
