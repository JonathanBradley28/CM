...
Peform MCMC diagnostics using R coda package. Note that alpha_delta does not mix well. Of course, one could thin, however, we choose not to. See MacEachern and Berliner (1994) for a discussion on thinning.
